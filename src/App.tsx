            ...
            <Routes>
              ...
              <Route path="/archives" element={<StaticPage title="Archives" content={
                <div className="space-y-6">
                  ...
                  <div className="p-12 bg-gray-50 rounded-3xl border border-gray-100 text-center">
                    <p className="text-gray-500 italic">Le module de recherche avancée dans les archives est en cours de maintenance. Merci de votre patience.</p>
                  </div>
                </div>
              } />} />
            </Routes>
